...
class DiseaseSeverity(Resource):
    def post(self):
        ...
        with open('distributions/disease_severity.csv', 'r') as read_obj:
            # pass the file object to reader() to get the reader object
            csv_reader = reader(read_obj)
            #Iterate over each row in the csv using reader object
            for row in csv_reader:
...
class DiseaseTest(Resource):
    def post(self):
        ...
        with open('distributions/Test_Diseases.csv', 'r') as read_obj:
            # pass the file object to reader() to get the reader object
            csv_reader = reader(read_obj)
            #Iterate over each row in the csv using reader object
            for row in csv_reader:
...
api.add_resource(DiseaseTest, '/API/getTest')
api.add_resource(DiseaseSeverity, '/API/getSeverity')
